            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6 md:mb-8">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <div className='flex flex-col'>
                        <h1 className="text-foreground text-2xl md:text-3xl font-bold">Create Role</h1>
                        <p className="text-gray-500 text-sm md:text-base">Add a new role and assign permissions</p>
                    </div>
                </div>
            </div>
