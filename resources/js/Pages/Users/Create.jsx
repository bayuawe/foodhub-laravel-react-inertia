            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6 md:mb-8">
                <div className="flex items-center gap-2 mb-1">
                    <Link href={route('users.index')}>
                        <Button variant="ghost" size="icon" className="h-15 w-15 rounded-full">
                            <ArrowLeft className="w-5 h-5" />
                        </Button>
                    </Link>
                    <div className='flex flex-col'>
                        <h1 className="text-foreground text-2xl md:text-3xl font-bold">Create User</h1>
                        <p className="text-gray-500 text-sm md:text-base">Add a new user to the system</p>
                    </div>
                </div>
            </div>
